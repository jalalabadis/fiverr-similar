...
import { CRIPTO_LOGIN_ROUTE, LOGIN_ROUTE, SIGNUP_ROUTE } from "../utils/constants";
...
function AuthWrapper({ type }) {
  ...
  ////Solana Cripto Wallet Login
  const handelwalletlogin = async () => {
    setIsLoading(true);
   ...
   const { data: { user, jwt }} = await axios.post(CRIPTO_LOGIN_ROUTE, { 
        ...
        >
          <div className="flex flex-col justify-center items-center p-8 gap-7">
            ...
            <div className="flex flex-col gap-5">
              ...
              <button onClick={handelwalletlogin} disabled={isLoading}
              className="text-white bg-black p-3 font-semibold w-80 flex items-center justify-center relative">
                <TbCurrencySolana className="absolute left-4 text-2xl" />
