...
export const PUBKEY = process.env.SOLANA_PUBKEY;
...
export const CRIPTO_LOGIN_ROUTE = `${AUTH_ROUTES}/cripto-login`;
...
export const ORDER_SOLANA_SUCCESS_ROUTE = `${ORDERS_ROUTES}/solana-success`;
